...
def build_index() -> str:
    ...
    A("")
    A("**One agent per game.** The two live games differ in view shape, move shape and clock — "
    ...
    A("- **Answer before the deadline** (shipped on the phase event). A miss forfeits the turn; "
      "repeated misses forfeit the match. Goofspiel falls back to your lowest card.")
