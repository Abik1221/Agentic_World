...
* **cli:** live agent console for onavion run (+ security hardening) ([9385063](https://github.com/Abik1221/Agentic_World/commit/9385063614f0636a7887a7d0a238d5658a821a80))
* **cli:** onavion login/logout/status/logs + secure credential storage ([5a97734](https://github.com/Abik1221/Agentic_World/commit/5a97734ac9e4235fdd775106a9ff57b652763073))
* **cli:** onavion play + watch (start & spectate — the agent plays, never the human) ([3e46e70](https://github.com/Abik1221/Agentic_World/commit/3e46e70fd3f2d8be57aea4cc5b10d264756d6e69))
...
* **sdk-py:** RuntimeConnector — dial-out WSS local runtime + onavion run ([3611aee](https://github.com/Abik1221/Agentic_World/commit/3611aeeacb215014a9ec47f65b8905f68688d0f2))
...
* **sdk:** onavion CLI — init / validate / simulate / publish ([345f9d4](https://github.com/Abik1221/Agentic_World/commit/345f9d488f6deedef0e95aca860d4ac97ff011d8))
