...
board state) is exposed as ``raw`` so the SDK stays thin and never drifts from
...
_VIEW_BY_GAME = {GOOFSPIEL: GoofspielView, MAFIA: MafiaView}
...
class GoofspielMove:
    ...
    # about four. Mafia works the same way (its public speech rides on its
